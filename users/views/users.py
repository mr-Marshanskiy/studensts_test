...
@extend_schema_view(
    post=extend_schema(summary='Registration', tags=['Authentication & Authentication']),
)
...
@extend_schema_view(
    post=extend_schema(
        ...
        summary='Password changing', tags=['Authentication & Authentication']),
)
...
@extend_schema_view(
    get=extend_schema(summary='Retrieve current user', tags=['Users']),
    patch=extend_schema(summary='Partial update current user', tags=['Users']),
)
...
@extend_schema_view(
    list=extend_schema(summary='User list for Search', tags=['Dicts']),
)
